...
void GraphicalUI::cb_antiEnabledCheckButton(Fl_Widget* o, void* v)
{
	GraphicalUI* pUI = (GraphicalUI*)(o->user_data());
	pUI->m_anti_enabled_value = (((Fl_Check_Button*)o)->value() == 1);
}
...
GraphicalUI::GraphicalUI() : m_nativeChooser(NULL) {
	...
	m_mainWindow = new Fl_Window(100, 40, 350, 310, "Ray <Not Loaded>");
		...
		m_anti_enabledCheckButton = new Fl_Check_Button(0, 230, 180, 20, "Anti-aliasing Enabled");
		m_anti_enabledCheckButton->user_data((void*)(this));
		m_anti_enabledCheckButton->callback(cb_antiEnabledCheckButton);
		m_anti_enabledCheckButton->value(m_anti_enabled_value);
