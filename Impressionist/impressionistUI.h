...
// for brush dialog
	...
	Fl_Light_Button*	m_RandButton;
	Fl_Button*          m_PaintItButton;
	Fl_Slider*			m_rSlider;
	Fl_Slider*			m_gSlider;
	Fl_Slider*			m_bSlider;
...
private:
	...
	static Fl_Menu_Item		strokeDirectionMenu[NUM_LDIRECTION_TYPE + 1];
	...
	static void cb_swap_paint(Fl_Menu_* o, void* v);
	...
	static void cb_paint_it_button(Fl_Widget* o, void* v);
	...
	static void cb_randButton(Fl_Widget* o, void* v);
};
